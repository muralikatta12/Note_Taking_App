...
document.getElementById('imageUpload').addEventListener('change', function(event) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            imgElement.src = e.target.result; // Set image source to the uploaded file
            imgElement.alt = 'Uploaded Image'; // Alt text for accessibility
            imagePreview.appendChild(imgElement); // Append the image to preview div
        };
